...
@synthesize selected,cacheContext,circleUIV;
...
- (id)initwithRadius:(CGFloat)radius
{
    ...
    circleUIV = [[UIImageView alloc]  initWithFrame:  self.bounds];
    [self addSubview:circleUIV];
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.selected) {
        circleUIV.image = [UIImage imageNamed:@"gesture_password_mark_actived"];
    }else {
        
        circleUIV.image = [UIImage imageNamed:@"gesture_password_mark"];
    }
